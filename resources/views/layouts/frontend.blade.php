          ...
          <div class="row">
            <div class="col-lg-6 col-md-6">
              <div class="header__top__left">
                <ul>
                  <li><i class="fa fa-envelope"></i> khalilurrachman@gmail.com</li>
                  <li>Fresh From the Field</li>
                </ul>
              </div>
            </div>
            <div class="col-lg-6 col-md-6">
        ...
        <div class="row">
          <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="footer__about">
              ...
              <ul>
                <li>Address: Sudiang Permai Panampu'</li>
                <li>Phone: +682271477100</li>
                <li>Email: khalilurrachman21@gmail.com</li>
              </ul>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-12">
            <div class="footer__widget">
              ...
              <div class="footer__widget__social">
                <a href="#"><i class="fa fa-facebook"></i></a>
                <a href="https://www.instagram.com/khalilurrg/?hl=id"><i class="fa fa-instagram"></i></a>
                <a href="#"><i class="fa fa-twitter"></i></a>
